...
android {
    ...
    compileOptions {
        ...
        // Wajib: flutter_local_notifications memakai API java.time yang tidak
        // ada di Android lama, dan menolak dibangun tanpa desugaring ini.
        isCoreLibraryDesugaringEnabled = true
    }

    defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId = "com.criss10x.habit_leveling"
